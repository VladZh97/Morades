        ...
        <div class="contact-main">
            ...
            <div class="contact-main__container container">
                <div class="contact-main__body">
                    <h3 class="contact-main__title"><?php the_field('contact-main__title')?></h3>
                    <div class="contact-main__items">
                    <p class="contact-main__item"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/phone.png" alt=""><a href="tel:<?= get_field('tel'); ?>"><?php the_field('tel'); ?></a></p>
                    <p class="contact-main__item"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/mail.png" alt=""><a href="mailto:<?= get_field('mail'); ?>"><?php the_field('mail'); ?></a></p>
                    <p class="contact-main__item"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/map.png" alt=""><span class="contact-main__street"><?php the_field('street')?></span></p>
                    </div>
                </div>
            </div>
        </div>

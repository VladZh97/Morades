...
<main class="front">
    <div class="container front__container">
        ...
        <div class="front__row">
            <div class="front__row-container">
                ...
                <!-- DESIGN ROW -->
                <div class="project__des front__des">
        ...
        <div class="front__container">
            <div class="front__row-container">
                ...
                <div class="campaign__des front__des">
    ...
    <div class="container front__container">
        <div class="front__row">
            <div class="front__row-container">
                <div class="realisations__des front__des">
        ...
        <div class="front__container">
            <div class="front__row-container">
                ...
                <div class="contact__des front__des">
    ...
    <div class="container front-footer__container">
        <div class="front-footer">
            ...
            <p class="front-footer__text"><?php the_field('front-footer_text'); ?></p>
        </div>
    </div>
</main>
